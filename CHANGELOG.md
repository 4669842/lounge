...
The Lounge v2.7.0 also comes with a few **deprecations**:
...
All deprecations above will be dropped in The Lounge, v3. We highly recommend upgrading to The Lounge v2.7.0 **before** upgrading to The Lounge v3 (the next version) to be warned about deprecated configurations.
